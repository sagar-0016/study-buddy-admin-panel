...
import { getRecentActivity, getRecentMoodEntries } from "@/lib/firebase-actions";
            ...
            <TableBody>
                {activities.map((activity) => (
                    <TableRow key={activity.id}>
                        ...
                        <Link href={activity.type === 'Doubt' ? '/doubts' : '/help'} className="text-primary hover:underline">View</Link>
                        </TableCell>
                    </TableRow>
                ))}
            </TableBody>
